...
const { Portrait } = require('../../models');
const { before: uploadBeforeHook } = require('./actions/upload-image-and-avatar.hook.js');
...
const options = {
  properties: {
    ...
    uploadAvatar: {
      isVisible: { new: true, list: true, show: true, delete: true, edit: true, filter: false },
      components: {
        new: AdminBro.bundle('./components/upload-avatar.edit.jsx'),
        edit: AdminBro.bundle('./components/upload-avatar.edit.jsx'),
        list: AdminBro.bundle('./components/upload-avatar.list.jsx'),
        show: AdminBro.bundle('./components/upload-avatar.list.jsx'),
      },
    },
  },
  actions: {

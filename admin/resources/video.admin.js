...
const options = {
  properties: {
    ...
    thumbnail: {
      isVisible: { new: true, show: false, list: false, filter: false, edit: true, }
    },
    content: {
      type: 'richtext',
      custom: {
    ...
    category: {
      availableValues: [
        { value: 'tv-romano-givipen', label: 'ТВ Романо Джівіпен' },
        { value: 'tv-romano-lav', label: 'ТВ Романо Лав' },
        { value: 'pap-jaz-fest', label: 'Пап Джаз Фест' },
        { value: 'other', label: 'Різне' },
      ],
    },
    comments: {
